  ...
  return (
    <>
      <div className="flex justify-between items-center   w-full h-20 px-8 text-white bg-black fixed">
        <div>
          <h1 className="text-5xl font-signature ml-2">Mritunjay</h1>
          {/* <h1 className="text-5xl font-signature1 ml-2">Mritunjay</h1> */}
        </div>
        ...
        <ul className="hidden md:flex">
          {links.map(({ id, link }) => (
            <li
              key={id}
              className=" px-4 cursor-pointer capitalize  font-semibold text-gray-400 hover: scale-105 duration-200"
            >
        ...
        <div
          ...
          className="cursor-pointer pr-5 z-10 text-grey-500 md:hidden "
        >
